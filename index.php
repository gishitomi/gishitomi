...
<body>
    <div id="index">
            ...
            <div class="menu-bar">
                <ul>
                    ...
                    <a class="underline" id="scroll_btn3" href=" ">
                        <li>IT業界のトレンド <i class="fas fa-laptop-code"></i></li>
                    </a>
        ...
        <main>
            ...
            <div class=" topic ">
                <img src="./assets/img/social-networks-1863613_1920.png" alt="">

                <!-- <div class="topic-box" id="box1">
                    <img src="./assets/img/twitter-312464_1280.png" alt="">
                </div>
                <div class="topic-box" id="box2">
                    <img src="./assets/img/logo-2582757_1920.png" alt="">
                </div>
                <div class="topic-box" id="box3"></div>
                <div class="topic-box" id="box4"></div> -->
